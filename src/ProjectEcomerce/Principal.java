...
public class Principal {
	...
	public static void main(String[] args) {
        ...
        Vendedor vendedorPadrao = new Vendedor("pedro", "loginpedro", "senhapedro", 1);
        Administrador administrador = new Administrador("thiago", "admin", "admin", 2);
        Cliente clientePadrao = new Cliente("breno", "loginbreno", "senhabreno", 3);
        ...
        do {
            ...
            if (loginOuCadastro == 1 && codigoUsuario == 2) {
                System.out.println("Erro! N�o pode existir mais de um Administrador\n");
